	...
	<view>
		...
		<view :class="{
		 ...
		 class="uni-fab__circle uni-fab__plus" :style="{ 'background-color': styles.buttonColor }" @click="_onClick">
			<slot></slot>
			<view class="fab-circle-v" :class="{'uni-fab__plus--active': isShow}" v-if="!$slots.default"></view>
			<view class="fab-circle-h" :class="{'uni-fab__plus--active': isShow}" v-if="!$slots.default"></view>
		</view>
	</view>
</template>
